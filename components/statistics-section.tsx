...
function StatisticsItem({ label, value, unit }: StatisticsItemProps) {
	return (
		<div className="flex flex-col items-center gap-2 sm:gap-3 md:gap-4">
			<p className="text-brand-main text-base sm:text-lg md:text-xl lg:text-2xl font-medium">
				{label}
			</p>
			<div className="flex items-baseline gap-1 sm:gap-2">
				<p className="text-gray-600 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium">
					{value}
				</p>
				<p className="text-brand-main text-base sm:text-lg md:text-xl lg:text-2xl font-medium">
					{unit}
